...
('ZHENSHI', 'C5',     '臻识 C5',            'CAMERA',  'MQTT',  '["DISPLAY_TEXT","DISPLAY_SAVE","DISPLAY_CONFIG","VOICE_CONTROL","DISPLAY_ENHANCED","PERIPHERAL_CONTROL","TIME_SYNC","OPEN_GATE","CLOSE_GATE","LOCK_OPEN_GATE","LOCK_CLOSE_GATE"]'),
...
('芊熠',   'QY-01',  '芊熠 QY-01',         'CAMERA',  'MQTT',  '["DISPLAY_TEXT","DISPLAY_SAVE","TIME_SYNC","OPEN_GATE","CLOSE_GATE","LOCK_OPEN_GATE","CAPTURE","VOICE_CONTROL"]'),
