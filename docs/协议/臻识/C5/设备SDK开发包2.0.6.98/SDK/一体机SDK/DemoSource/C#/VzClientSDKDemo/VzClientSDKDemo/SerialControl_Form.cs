...
namespace VzClientSDKDemo
{
    public partial class SerialControl_Form : Form
    {
        ...
        private VzClientSDK.VZDEV_SERIAL_RECV_DATA_CALLBACK serial_recv_ = null;
        ...
        private void SerialControl_Form_Load(object sender, EventArgs e)
        {
            ...
            serial_recv_ = new VzClientSDK.VZDEV_SERIAL_RECV_DATA_CALLBACK(OnserialRECV);
        ...
        private int OnserialRECV(int nSerialHandle, IntPtr pRecvData, int uRecvSize, IntPtr pUserData)
        {
            if ( nSerialHandle == serial_handle_ && pRecvData != IntPtr.Zero && uRecvSize > 0 )
            {
                ...
                Win32API.PostMessage(hwndMain, MSG_SERIAL_RECV, (IntPtr)0, (IntPtr)0);
            }
