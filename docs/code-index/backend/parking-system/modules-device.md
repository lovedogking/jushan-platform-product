...
> **最近更新**：2026-07-25（v2.2：VoiceControlRequest 字段 voiceId/variable → voiceText/opt 对齐 device-access 文本匹配模式；DeviceController.voiceControl + DeviceService.voiceControl 签名同步；DeviceStatusPollingTask 写快照表；WebSocket /ws 端点 Security 放行）
