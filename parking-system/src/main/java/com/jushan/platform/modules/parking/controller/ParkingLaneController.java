...
import com.jushan.platform.modules.parking.dto.CreateLaneRequest;
import com.jushan.platform.modules.parking.dto.UpdateLaneRequest;
import com.jushan.platform.modules.parking.service.ParkingLaneService;
import com.jushan.platform.modules.parking.vo.ParkingLaneVO;
...
@RequireRole("platform") // SA-02: 仅超管（V1.4 权限矩阵修正）
