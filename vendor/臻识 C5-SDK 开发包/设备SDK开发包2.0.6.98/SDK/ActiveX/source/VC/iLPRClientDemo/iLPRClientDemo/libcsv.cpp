...
size_t csv_parse(struct csv_parser *p,
  ...
  unsigned const char *us = (unsigned char *)(s);
  /* The character we are currently processing */
  unsigned char c;
  /* The number of characters we have processed in this call */
  size_t pos = 0;
