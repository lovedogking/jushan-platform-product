...
typedef enum
{
	...
	TRIGGER_TYPE_RETENTION_BIT	= 64,   //车辆滞留
	TRIGGER_TYPE_LEAVE_BIT		= 65,   //车辆滞留解除
	TRIGGER_TYPE_TURNBACK_BIT   = 66    //车辆折返事件
}TH_TRIGGER_TYPE_BIT;
...
#define MAX_MATE_COUNT  10

typedef struct {
	VZ_LPRC_MATE_ITEM mate_items[MAX_MATE_COUNT];
	int mate_count;
}VZ_LPRC_MATE_INFO;
